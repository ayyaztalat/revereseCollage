package com.picspool.libfuncview.background.view;
...
public class CSCircleIndicator extends LinearLayout {
    ...
    public CSCircleIndicator(Context context) {
        ...
        this.mInternalPageChangeListener = new ViewPager.OnPageChangeListener() { // from class: com.picspool.libfuncview.background.view.CSCircleIndicator.1
        ...
        this.mInternalDataSetObserver = new DataSetObserver() { // from class: com.picspool.libfuncview.background.view.CSCircleIndicator.2
