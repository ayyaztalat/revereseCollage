...
public class CSLayerRes extends DMWBImageRes {
    ...
    private void getOnlineBitmap(final DMWBImageRes.OnResImageLoadListener onResImageLoadListener) {
        ...
        if (TextUtils.isEmpty(str)) {
            DMAsyncTextHttp.asyncHttpRequest(this.imageFileName, new DMAsyncTextHttp.AsyncTextHttpTaskListener() { // from class: com.picspool.libfuncview.effect.blend.CSLayerRes.1
                ...
                public void onRequestDidFinishLoad(String str2) {
                    try {
                        ...
                        if (jSONObject.getInt("status") == 1) {
                            ...
                            DMPreferencesUtil.save(CSLayerRes.this.context, "DMAsyncImageLoader", CSLayerRes.this.imageFileName, string);
                            Bitmap loadOnlineBitmapFromUrl = CSLayerRes.this.loadOnlineBitmapFromUrl(string, onResImageLoadListener);
    ...
    public Bitmap loadOnlineBitmapFromUrl(String str, final DMWBImageRes.OnResImageLoadListener onResImageLoadListener) {
        Log.e("url", str);
        Bitmap loadImageBitamp = new DMAsyncImageLoader().loadImageBitamp(this.context, str, new DMAsyncImageLoader.ImageCallback() { // from class: com.picspool.libfuncview.effect.blend.CSLayerRes.2
