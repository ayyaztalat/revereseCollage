...
public class CSCircleIndicator extends LinearLayout {
    ...
    public CSCircleIndicator(Context context) {
        ...
        this.mInternalPageChangeListener = new ViewPager.OnPageChangeListener() { // from class: com.picspool.libfuncview.xlbsticker.stickerbar.CSCircleIndicator.1
        ...
        this.mInternalDataSetObserver = new DataSetObserver() { // from class: com.picspool.libfuncview.xlbsticker.stickerbar.CSCircleIndicator.2
