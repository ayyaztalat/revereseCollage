package com.picspool.lib.otherapp;
...
public class DMOtherApp {
    ...
    public static void openInMarket(Context context, String str) {
        try {
            try {
                if (isInstalled(context, DMOtherAppPackages.googleplayPackage).booleanValue()) {
