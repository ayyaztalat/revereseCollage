...
public class DMGalleryPointerView extends View {
    ...
    public DMGalleryPointerView(Context context) {
        super(context);
        this.mItemWidth = 0;
        this.mItemHeight = 0;
        this.mBorderWidth = 0;
        ...
        this.mItemBorderColor = ViewCompat.MEASURED_STATE_MASK;
    ...
    public DMGalleryPointerView(Context context, AttributeSet attributeSet) {
    ...
    public DMGalleryPointerView(Context context, AttributeSet attributeSet, int i) {
    ...
    public void setPointerItemSize(int i, int i2) {
        ...
        int dip2px = DMScreenInfoUtil.dip2px(this.mContext, i2);
