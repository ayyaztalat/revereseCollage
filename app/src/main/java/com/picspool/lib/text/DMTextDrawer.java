...
public class DMTextDrawer {
    ...
    public DMTextBgRes mBackgroundRes;
    public int mBgH;
    public int mBgImageHeight;
    public int mBgImageWidth;
    public int mBgW;
    public int mBgX;
    public int mBgY;
    private int mBorderColor;
    private int mBorderWidth;
    public boolean mIsImageBackground;
    ...
    public DMTextDrawer(Context context, String str, int i) {
        ...
        this.mBackgroundDrawable = null;
        this.BMImager = new DMImager(this);
    ...
    public void drawInCanvas(Canvas canvas, int i, int i2) {
        ...
        this.BMImager.drawInCanvas(canvas, i, i2);
    ...
    private Rect[] computeDrawTextRects() {
        ...
        if (this.text.contains("\n") && !this.ignoreLine) {
            String[] split = this.text.split("\n");
            int i = C33201.$SwitchMap$org$picspool$lib$text$DMTextDrawer$TEXTALIGN[this.textAlign.ordinal()];
            if (i == 1) {
    ...
    public Rect getBgContentRect() {
        return this.BMImager.getImageContentRect();
    }
    ...
    public Rect getContentRect() {
        if (this.mBackgroundDrawable != null) {
            ...
            int i = this.mBgX;
            int i2 = width + i + ((this.mBgImageWidth - i) - this.mBgW);
            int i3 = this.mBgY;
            return new Rect(0, 0, i2, height + i3 + ((this.mBgImageHeight - i3) - this.mBgH));
        }
        int i4 = this.BMImager.getImageContentRect().left;
        int i5 = this.BMImager.getImageContentRect().top;
        int i6 = this.rect.right - this.BMImager.getImageContentRect().right;
        int i7 = this.rect.bottom - this.BMImager.getImageContentRect().bottom;
        if (i4 >= i6) {
            i4 = i6;
        }
        if (i5 >= i7) {
    ...
    public void setImagerDrawable(DMImager.StretchDrawable stretchDrawable, DMImager.LeftDrawable leftDrawable, DMImager.TopDrawable topDrawable, DMImager.RightDrawable rightDrawable, DMImager.BottomDrawable bottomDrawable) {
        this.BMImager.setImagerDrawable(stretchDrawable, leftDrawable, topDrawable, rightDrawable, bottomDrawable);
        updateData();
    }

    public void setImagerDrawable(DMImager.ImageDrawable imageDrawable) {
        this.BMImager.setImagerDrawable(imageDrawable);
        updateData();
    }
    ...
    /* renamed from: com.picspool.lib.text.DMTextDrawer$1 */
    /* loaded from: classes3.dex */
    public static  class C33201 {
        public static int[] $SwitchMap$org$picspool$lib$text$DMTextDrawer$SHADOWALIGN;
        ...
        static {
            ...
            try {
                $SwitchMap$org$picspool$lib$text$DMTextDrawer$SHADOWALIGN[SHADOWALIGN.LEFT_TOP.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$org$picspool$lib$text$DMTextDrawer$SHADOWALIGN[SHADOWALIGN.LEFT_BOTTOM.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$org$picspool$lib$text$DMTextDrawer$SHADOWALIGN[SHADOWALIGN.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$org$picspool$lib$text$DMTextDrawer$SHADOWALIGN[SHADOWALIGN.RIGHT_TOP.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                $SwitchMap$org$picspool$lib$text$DMTextDrawer$SHADOWALIGN[SHADOWALIGN.RIGHT_BOTTOM.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                $SwitchMap$org$picspool$lib$text$DMTextDrawer$SHADOWALIGN[SHADOWALIGN.TOP.ordinal()] = 7;
            ...
            try {
                $SwitchMap$org$picspool$lib$text$DMTextDrawer$TEXTALIGN[TEXTALIGN.CENTER.ordinal()] = 2;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                $SwitchMap$org$picspool$lib$text$DMTextDrawer$TEXTALIGN[TEXTALIGN.RIGHT.ordinal()] = 3;
    ...
    public void setPaintShadowLayer(SHADOWALIGN shadowalign) {
        ...
        switch (C33201.$SwitchMap$org$picspool$lib$text$DMTextDrawer$SHADOWALIGN[shadowalign.ordinal()]) {
            case 1:
    ...
    public void cleanImagerDrawable() {
        this.BMImager.cleanImagerDrawable();
    }
    ...
    public int getBgAlpha() {
        return this.BMImager.getAlpha();
    }

    public void setBgAlpha(int i) {
        this.BMImager.setAlpha(i);
    }
    ...
    public void setEditTextBackgroundDrawable(Drawable drawable, DMTextBgRes dMTextBgRes, int i, int i2, int i3, int i4, int i5, int i6) {
        if (drawable != null) {
            this.mIsImageBackground = true;
        } else {
            this.mIsImageBackground = false;
        }
        this.mBackgroundRes = dMTextBgRes;
        this.mBackgroundDrawable = drawable;
        this.mBgImageWidth = i;
    ...
    public void setIsBackgroundImageDrawable(boolean z) {
        this.mIsImageBackground = z;
    }

    public boolean isBackgroundImageDrawable() {
        return this.mIsImageBackground;
    }
}
