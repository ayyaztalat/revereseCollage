...
public class LibDMCommonMaskImageViewTouch extends ImageViewTouch {
    ...
    static /* synthetic */ int access$108(LibDMCommonMaskImageViewTouch libDMCommonMaskImageViewTouch) {
        int i = libDMCommonMaskImageViewTouch.timer;
        libDMCommonMaskImageViewTouch.timer = i + 1;
        return i;
    }
    ...
    public LibDMCommonMaskImageViewTouch(Context context) {
        ...
        this.clickHandler = new Handler() { // from class: com.picspool.lib.collagelib.LibDMCommonMaskImageViewTouch.1
            @Override // android.os.Handler
            public void handleMessage(Message message) {
                if (message.what == 0) {
                    LibDMCommonMaskImageViewTouch.this.keyUpDown = true;
                    LibDMCommonMaskImageViewTouch.this.timer = 0;
                    LibDMCommonMaskImageViewTouch.this.keyUpDownListener();
                    LibDMCommonMaskImageViewTouch.this.mClickListener.CustomeClick(LibDMCommonMaskImageViewTouch.this.index);
                } else if (message.what == 1) {
                    LibDMCommonMaskImageViewTouch.this.keyUpDown = false;
                    LibDMCommonMaskImageViewTouch.this.timer = 0;
                    if (LibDMCommonMaskImageViewTouch.this.longclickEnable.booleanValue()) {
                        return;
                    }
                    LibDMCommonMaskImageViewTouch.this.mClickListener.CustomeTouchUp(LibDMCommonMaskImageViewTouch.this.index);
                } else if (message.what == 100) {
                    if (LibDMCommonMaskImageViewTouch.this.mLongClickListener != null && LibDMCommonMaskImageViewTouch.this.mIsUstingLongclick.booleanValue()) {
                        LibDMCommonMaskImageViewTouch.this.mLongClickListener.CustomeLongClick(LibDMCommonMaskImageViewTouch.this.index);
                        LibDMCommonMaskImageViewTouch.this.setlongclickEnable(true);
                    }
                    LibDMCommonMaskImageViewTouch.this.timer = 0;
                }
            }
        ...
        try {
            try {
                ...
                if (this.mRotationDegree != 0.0f) {
                    float rotationScale = getRotationScale(this.mRotationDegree, f7, f8);
                    ...
                    try {
                        ...
                        getRotationScale(this.mRotationDegree, f7, f8);
                    } catch (Exception e) {
                        e = e;
                        str2 = str;
                ...
                if (this.mMask == null) {
                    if (this.mIsShowFrame.booleanValue()) {
                        ...
                        matrix5.postScale(f6, f5);
                        this.shadowMatrix.postTranslate(f9, f9);
                        path.transform(this.shadowMatrix);
                        canvas.drawPath(path, this.mPaint);
                        Matrix matrix6 = new Matrix();
                        this.shadowMatrix = matrix6;
                        float f11 = -i4;
                        matrix6.postTranslate(f11, f11);
                        path.transform(this.shadowMatrix);
                        ...
                        matrix7.postScale(((f7 - 30.0f) / f7) * width, ((f8 - 30.0f) / f8) * height);
                        ...
                        matrix8.postScale(((f7 - 20.0f) / f7) * width, ((f8 - 20.0f) / f8) * height);
                    ...
                    if (this.mIsUsingShadow.booleanValue()) {
                        ...
                        this.shadowMatrix = matrix11;
                        matrix11.postScale(f2, f17);
                    ...
                    if (this.mIsUsingShadow.booleanValue() && this.padding > 0) {
                        getWidth();
                        Bitmap creatBlurMaskBitmap = creatBlurMaskBitmap(this.mMask, (int) ((f7 * 1.0f) + 0.5f), (int) ((f8 * 1.0f) + 0.5f), blurMaskFilter);
                        Paint paint3 = new Paint();
                        paint3.setAntiAlias(true);
                        canvas.drawBitmap(creatBlurMaskBitmap, (Rect) null, new Rect(0, 0, i, i2), paint3);
                        ...
                        float f18 = -i3;
                        matrix12.postTranslate(f18, f18);
                        path.transform(this.shadowMatrix);
                    }
                    f5 = f3;
                    f6 = f4;
                ...
                if (this.mIsUsingShadow.booleanValue() || this.mIsShowFrame.booleanValue()) {
                    ...
                    matrix13.postScale(1.0f / f6, 1.0f / f5);
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [com.picspool.lib.collagelib.LibDMCommonMaskImageViewTouch$2] */
    public int keyUpDownListener() {
        new Thread() { // from class: com.picspool.lib.collagelib.LibDMCommonMaskImageViewTouch.2
            @Override // java.lang.Thread, java.lang.Runnable
            public void run() {
                while (LibDMCommonMaskImageViewTouch.this.keyUpDown) {
                    try {
                        sleep(200L);
                        LibDMCommonMaskImageViewTouch.access$108(LibDMCommonMaskImageViewTouch.this);
                        Log.d("info", "timing:timer=" + LibDMCommonMaskImageViewTouch.this.timer + "  currentEvent" + LibDMCommonMaskImageViewTouch.this.currentEvent);
                        if (LibDMCommonMaskImageViewTouch.this.currentEvent == 0 || !LibDMCommonMaskImageViewTouch.this.isMoved) {
                            if (LibDMCommonMaskImageViewTouch.this.timer > 2 && LibDMCommonMaskImageViewTouch.this.mLongClickListener != null) {
                                Looper.prepare();
                                LibDMCommonMaskImageViewTouch.this.clickHandler.sendEmptyMessage(100);
                                Looper.loop();
                                LibDMCommonMaskImageViewTouch.this.isMoved = false;
                            }
                        }
        ...
        try {
            try {
                ...
                if (this.mPath != null) {
                    ...
                    if (this.mMask == null) {
                        if (this.mIsShowFrame.booleanValue()) {
                            ...
                            matrix4.postScale((getWidth() - 30.0f) / getWidth(), (getHeight() - 30.0f) / getHeight());
                            this.shadowMatrix.postTranslate(15.0f, 15.0f);
                            path.transform(this.shadowMatrix);
                            paint.setMaskFilter(new BlurMaskFilter(15.0f, BlurMaskFilter.Blur.OUTER));
                            paint.setAntiAlias(true);
                            ...
                            Matrix matrix5 = new Matrix();
                            this.shadowMatrix = matrix5;
                            matrix5.postScale((getWidth() - 20.0f) / getWidth(), (getHeight() - 20.0f) / getHeight());
                            this.shadowMatrix.postTranslate(10.0f, 10.0f);
                            path2.transform(this.shadowMatrix);
                            paint2.setColor(-1);
                        ...
                        if (this.mIsUsingShadow.booleanValue() && this.padding > 0) {
                            ...
                            canvas.drawBitmap(creatBlurMaskBitmap, (Rect) null, new Rect(0, 0, getWidth(), getHeight()), paint3);
                            if (creatBlurMaskBitmap != this.mMask && !creatBlurMaskBitmap.isRecycled()) {
                                creatBlurMaskBitmap.recycle();
                            }
                            Matrix matrix9 = new Matrix();
                            this.shadowMatrix = matrix9;
                            matrix9.postTranslate(-this.padding, -this.padding);
                            this.mPath.transform(this.shadowMatrix);
                        }
                        f = f3;
                        f2 = f4;
                ...
                if (this.isDrowRect.booleanValue()) {
                    ...
                    Matrix matrix13 = new Matrix();
                    this.matrix = matrix13;
                    matrix13.postTranslate((-2) - this.padding, (-2) - this.padding);
                    this.matrix.postScale(1.0f / f9, 1.0f / f10);
                    this.mPath.transform(this.matrix);
                    if (this.mIsShowFrame.booleanValue() && !this.mIsUsingShadow.booleanValue()) {
                        Matrix matrix14 = new Matrix();
                        this.shadowMatrix = matrix14;
                        float f11 = -6;
