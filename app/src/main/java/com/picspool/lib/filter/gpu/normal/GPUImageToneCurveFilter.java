...
public class GPUImageToneCurveFilter extends GPUImageFilter {
    ...
    public GPUImageToneCurveFilter(String str) {
    ...
    private void updateToneCurveTexture() {
        runOnDraw(new Runnable() { // from class: com.picspool.lib.filter.gpu.normal.GPUImageToneCurveFilter.1
            ...
            public void run() {
                ...
                for (int i = 0; i < 256; i++) {
                    int i2 = i * 4;
                    float f = i;
                    bArr[i2] = (byte) (((int) Math.min(Math.max(((Float) GPUImageToneCurveFilter.this.mRedCurve.get(i)).floatValue() + f + ((Float) GPUImageToneCurveFilter.this.mRgbCompositeCurve.get(i)).floatValue(), 0.0f), 255.0f)) & 255);
                    bArr[i2 + 1] = (byte) (((int) Math.min(Math.max(((Float) GPUImageToneCurveFilter.this.mGreenCurve.get(i)).floatValue() + f + ((Float) GPUImageToneCurveFilter.this.mRgbCompositeCurve.get(i)).floatValue(), 0.0f), 255.0f)) & 255);
                    bArr[i2 + 2] = (byte) (((int) Math.min(Math.max(f + ((Float) GPUImageToneCurveFilter.this.mBlueCurve.get(i)).floatValue() + ((Float) GPUImageToneCurveFilter.this.mRgbCompositeCurve.get(i)).floatValue(), 0.0f), 255.0f)) & 255);
                    bArr[i2 + 3] = -1;
                }
    ...
    private ArrayList<Float> createSplineCurve(PointF[] pointFArr) {
        ...
        Arrays.sort(pointFArr2, new Comparator<PointF>() { // from class: com.picspool.lib.filter.gpu.normal.GPUImageToneCurveFilter.2
