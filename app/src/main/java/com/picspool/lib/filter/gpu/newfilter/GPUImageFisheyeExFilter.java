...
public class GPUImageFisheyeExFilter extends GPUImageFisheyeFilter {
    ...
    public GPUImageFisheyeExFilter(String str) {
        super(str);
        this.mBlurSize = 1.0f;
        this.mRatio = 1.0f;
        this.mIsBlur = false;
    ...
    public GPUImageFisheyeExFilter(String str, float f, boolean z, float[] fArr, boolean z2, boolean z3, float f2, float f3, float f4) {
    ...
    public void setBlurSize(float f) {
        this.mBlurSize = f;
        runOnDraw(new Runnable() { // from class: com.picspool.lib.filter.gpu.newfilter.GPUImageFisheyeExFilter.1
