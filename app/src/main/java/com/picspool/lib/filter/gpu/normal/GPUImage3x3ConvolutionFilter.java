...
public class GPUImage3x3ConvolutionFilter extends GPUImage3x3TextureSamplingFilter {
    ...
    @Override // com.picspool.lib.filter.gpu.normal.GPUImage3x3TextureSamplingFilter, com.picspool.lib.filter.gpu.father.GPUImageFilter
    public void onInit() {
        super.onInit();
    ...
    public void setConvolutionKernel(float[] fArr) {
        this.mConvolutionKernel = fArr;
        setUniformMatrix3f(this.mUniformConvolutionMatrix, fArr);
    }
}
