...
public abstract class DMWBRes {
    ...
    public void getAsyncIconBitmap(DMWBAsyncPostIconListener dMWBAsyncPostIconListener) {
    }
    ...
    public Bitmap getIconBitmap() {
        ...
        if (this.iconType == LocationType.RES) {
            return DMBitmapUtil.getImageFromResourceFile(getResources(), this.iconID);
        }
        if (this.iconType == LocationType.ASSERT) {
            return DMBitmapUtil.getImageFromAssetsFile(getResources(), this.iconFileName);
        }
