...
public class BMLabelPagerAdapter extends PagerAdapter {
    ...
    private BMLabelManager labelManager;
    private BMListLabelView listLabelView;
    ...
    public BMLabelPagerAdapter(BMListLabelView bMListLabelView) {
        Context context = bMListLabelView.getContext();
        this.context = context;
        this.listLabelView = bMListLabelView;
        this.labelManager = new BMLabelManager(context);
        this.views = new ArrayList();
        this.icViews = new ArrayList();
        LayoutInflater layoutInflater = (LayoutInflater) this.context.getSystemService("layout_inflater");
        View inflate = layoutInflater.inflate(R.layout.dm_label_pager_view_x1, (ViewGroup) null);
        View inflate2 = layoutInflater.inflate(R.layout.dm_label_pager_view_x2, (ViewGroup) null);
        View inflate3 = layoutInflater.inflate(R.layout.dm_label_pager_view_x3, (ViewGroup) null);
        ...
        for (ImageView imageView : this.icViews) {
            if (imageView != null) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() { // from class: com.picspool.lib.label.edit.BMLabelPagerAdapter.1
                    @Override // android.view.View.OnClickListener
                    public void onClick(View view) {
                        try {
                            BMLabelPagerAdapter.this.listLabelView.editText(BMLabelPagerAdapter.this.labelManager.getTextDrawer(((Integer) view.getTag()).intValue()));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
