...
public class CSTResInfo extends DMWBImageRes {
    ...
    public int price;
    public int resId;
    protected CSEResType resType;
    private String shareTag;
    public int useCount;

    public CSEResType getResType() {
        return this.resType;
    }

    public void setResType(CSEResType cSEResType) {
        this.resType = cSEResType;
    }
