...
public class CSAsyncSizeProcess {
    ...
    public void execute() {
        new Thread(new Runnable() { // from class: com.picspool.libsquare.view.CSAsyncSizeProcess.1
            ...
            public void run() {
                try {
                    ...
                    CSAsyncSizeProcess.this.handler.post(new Runnable() { // from class: com.picspool.libsquare.view.CSAsyncSizeProcess.1.1
                        @Override // java.lang.Runnable
                        public void run() {
