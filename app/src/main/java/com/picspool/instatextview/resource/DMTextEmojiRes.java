...
public class DMTextEmojiRes extends DMWBImageRes {
    ...
    public Bitmap getImageBitmapFromUrl(final ImageView imageView, int i) {
        ...
        return dMAsyncImageLoader.loadImageBitamp(this.context, getIconFileName(), new DMAsyncImageLoader.ImageCallback() { // from class: com.picspool.instatextview.resource.DMTextEmojiRes.1
