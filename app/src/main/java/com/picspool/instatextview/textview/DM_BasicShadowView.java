...
public class DM_BasicShadowView extends FrameLayout {
    ...
    public DM_BasicShadowView(Context context) {
        super(context);
        iniView(context);
    }
    ...
    public DM_BasicShadowView(Context context, AttributeSet attributeSet, int i) {
    ...
    private void iniView(Context context) {
        ...
        this.leftAlignButton.setOnClickListener(new OnClickListener() { // from class: com.picspool.instatextview.textview.DM_BasicShadowView.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                DM_BasicShadowView.this.fixedView.setTextAlign(DMTextDrawer.TEXTALIGN.LEFT);
                DM_BasicShadowView.this.leftAlignButton.setSelected(true);
                DM_BasicShadowView.this.centreAlignButton.setSelected(false);
                DM_BasicShadowView.this.rightAlignButton.setSelected(false);
            }
        });
        this.centreAlignButton.setOnClickListener(new OnClickListener() { // from class: com.picspool.instatextview.textview.DM_BasicShadowView.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                DM_BasicShadowView.this.fixedView.setTextAlign(DMTextDrawer.TEXTALIGN.CENTER);
                DM_BasicShadowView.this.leftAlignButton.setSelected(false);
                DM_BasicShadowView.this.centreAlignButton.setSelected(true);
                DM_BasicShadowView.this.rightAlignButton.setSelected(false);
            }
        });
        this.rightAlignButton.setOnClickListener(new OnClickListener() { // from class: com.picspool.instatextview.textview.DM_BasicShadowView.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                DM_BasicShadowView.this.fixedView.setTextAlign(DMTextDrawer.TEXTALIGN.RIGHT);
                DM_BasicShadowView.this.leftAlignButton.setSelected(false);
                DM_BasicShadowView.this.centreAlignButton.setSelected(false);
                DM_BasicShadowView.this.rightAlignButton.setSelected(true);
            }
        });
        this.topShadowButton.setOnClickListener(new OnClickListener() { // from class: com.picspool.instatextview.textview.DM_BasicShadowView.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                DM_BasicShadowView.this.invalidShadows();
                if (DM_BasicShadowView.this.fixedView.getPaintShadowLayer() == DMTextDrawer.SHADOWALIGN.TOP) {
                    DM_BasicShadowView.this.fixedView.setPaintShadowLayer(DMTextDrawer.SHADOWALIGN.NONE);
                    DM_BasicShadowView.this.topShadowButton.setSelected(false);
                    return;
                }
                DM_BasicShadowView.this.fixedView.setPaintShadowLayer(DMTextDrawer.SHADOWALIGN.TOP);
                DM_BasicShadowView.this.topShadowButton.setSelected(true);
            }
        });
        this.rightTopShadowButton.setOnClickListener(new OnClickListener() { // from class: com.picspool.instatextview.textview.DM_BasicShadowView.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                DM_BasicShadowView.this.invalidShadows();
                if (DM_BasicShadowView.this.fixedView.getPaintShadowLayer() == DMTextDrawer.SHADOWALIGN.RIGHT_TOP) {
                    DM_BasicShadowView.this.fixedView.setPaintShadowLayer(DMTextDrawer.SHADOWALIGN.NONE);
                    DM_BasicShadowView.this.rightTopShadowButton.setSelected(false);
                    return;
                }
                DM_BasicShadowView.this.fixedView.setPaintShadowLayer(DMTextDrawer.SHADOWALIGN.RIGHT_TOP);
                DM_BasicShadowView.this.rightTopShadowButton.setSelected(true);
            }
        });
        this.rightBottomShadowButton.setOnClickListener(new OnClickListener() { // from class: com.picspool.instatextview.textview.DM_BasicShadowView.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                DM_BasicShadowView.this.invalidShadows();
                if (DM_BasicShadowView.this.fixedView.getPaintShadowLayer() == DMTextDrawer.SHADOWALIGN.RIGHT_BOTTOM) {
                    DM_BasicShadowView.this.fixedView.setPaintShadowLayer(DMTextDrawer.SHADOWALIGN.NONE);
                    DM_BasicShadowView.this.rightBottomShadowButton.setSelected(false);
                    return;
                }
                DM_BasicShadowView.this.fixedView.setPaintShadowLayer(DMTextDrawer.SHADOWALIGN.RIGHT_BOTTOM);
                DM_BasicShadowView.this.rightBottomShadowButton.setSelected(true);
            }
        });
        this.leftTopShadowButton.setOnClickListener(new OnClickListener() { // from class: com.picspool.instatextview.textview.DM_BasicShadowView.7
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                DM_BasicShadowView.this.invalidShadows();
                if (DM_BasicShadowView.this.fixedView.getPaintShadowLayer() == DMTextDrawer.SHADOWALIGN.LEFT_TOP) {
                    DM_BasicShadowView.this.leftTopShadowButton.setSelected(false);
                    DM_BasicShadowView.this.fixedView.setPaintShadowLayer(DMTextDrawer.SHADOWALIGN.NONE);
                    return;
                }
                DM_BasicShadowView.this.fixedView.setPaintShadowLayer(DMTextDrawer.SHADOWALIGN.LEFT_TOP);
                DM_BasicShadowView.this.leftTopShadowButton.setSelected(true);
            }
        });
        this.leftBottomShadowButton.setOnClickListener(new OnClickListener() { // from class: com.picspool.instatextview.textview.DM_BasicShadowView.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                DM_BasicShadowView.this.invalidShadows();
                if (DM_BasicShadowView.this.fixedView.getPaintShadowLayer() == DMTextDrawer.SHADOWALIGN.LEFT_BOTTOM) {
                    DM_BasicShadowView.this.fixedView.setPaintShadowLayer(DMTextDrawer.SHADOWALIGN.NONE);
                    DM_BasicShadowView.this.leftBottomShadowButton.setSelected(false);
                    return;
                }
                DM_BasicShadowView.this.fixedView.setPaintShadowLayer(DMTextDrawer.SHADOWALIGN.LEFT_BOTTOM);
                DM_BasicShadowView.this.leftBottomShadowButton.setSelected(true);
            }
        });
        this.bottomShadowButton.setOnClickListener(new OnClickListener() { // from class: com.picspool.instatextview.textview.DM_BasicShadowView.9
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                DM_BasicShadowView.this.invalidShadows();
                if (DM_BasicShadowView.this.fixedView.getPaintShadowLayer() == DMTextDrawer.SHADOWALIGN.BOTTOM) {
                    DM_BasicShadowView.this.fixedView.setPaintShadowLayer(DMTextDrawer.SHADOWALIGN.NONE);
                    DM_BasicShadowView.this.bottomShadowButton.setSelected(false);
                    return;
                }
                DM_BasicShadowView.this.fixedView.setPaintShadowLayer(DMTextDrawer.SHADOWALIGN.BOTTOM);
                DM_BasicShadowView.this.bottomShadowButton.setSelected(true);
            }
        });
        this.strokeButton.setOnClickListener(new OnClickListener() { // from class: com.picspool.instatextview.textview.DM_BasicShadowView.10
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (DM_BasicShadowView.this.fixedView.isShowSideTraces()) {
                    DM_BasicShadowView.this.fixedView.setShowSideTraces(false);
                    DM_BasicShadowView.this.strokeButton.setSelected(false);
                    DM_BasicShadowView.this.colorGalleryView.setFocusable(false);
                } else {
                    DM_BasicShadowView.this.fixedView.setShowSideTraces(true);
                    DM_BasicShadowView.this.strokeButton.setSelected(true);
                    DM_BasicShadowView.this.colorGalleryView.setFocusable(true);
                }
                if (DM_BasicShadowView.this.fixedView != null) {
                    DM_BasicShadowView.this.fixedView.invalidate();
                }
            }
        });
        this.seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.picspool.instatextview.textview.DM_BasicShadowView.11
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                DM_BasicShadowView.this.fixedView.setTextAlpha(255 - i);
                DM_BasicShadowView.this.fixedView.invalidate();
            }
        });
    }
    ...
    public void setFixedView(DM_TextFixedView dM_TextFixedView) {
        ...
        this.colorGalleryView.setListener(new OnDMColorChangedListener() { // from class: com.picspool.instatextview.textview.DM_BasicShadowView.12
            @Override // com.picspool.lib.widget.listener.OnDMColorChangedListener
            public void onColorChanged(int i) {
                int i2 = 0;
                while (true) {
                    if (DM_BasicShadowView.this.fixedView.getTextDrawer() == null || !DM_BasicShadowView.this.iniFlag || i2 >= DMSysColors.length) {
                        break;
                    } else if (i == DMSysColors.getColor(i2)) {
                        DM_BasicShadowView.this.fixedView.setSideTracesColor(i);
                        DM_BasicShadowView.this.fixedView.getTextDrawer().setSideTracesColorIndex(i2);
                        DM_BasicShadowView.this.fixedView.invalidate();
                        break;
                    } else {
                        i2++;
                ...
                if (DM_BasicShadowView.this.iniFlag) {
                    return;
                }
                DM_BasicShadowView.this.iniFlag = true;
            }
        });
    }
    ...
    public void iniData() {
        ...
        int i = C302013.$SwitchMap$org$picspool$lib$text$DMTextDrawer$TEXTALIGN[this.textFixedView.getTextAlign().ordinal()];
        if (i == 1) {
            this.leftAlignButton.setSelected(true);
        } else if (i == 2) {
    ...
    /* renamed from: com.picspool.instatextview.textview.DM_BasicShadowView$13 */
    /* loaded from: classes3.dex */
    public static  class C302013 {
