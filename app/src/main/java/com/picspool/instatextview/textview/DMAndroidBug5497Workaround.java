...
public class DMAndroidBug5497Workaround {
    ...
    private DMAndroidBug5497Workaround(Activity activity) {
        ...
        childAt.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.picspool.instatextview.textview.DMAndroidBug5497Workaround.1
