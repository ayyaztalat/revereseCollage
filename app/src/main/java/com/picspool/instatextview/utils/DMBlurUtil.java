package com.picspool.instatextview.utils;
...
public class DMBlurUtil {
    public static Bitmap fastblur(Context context, Bitmap bitmap, int i) {
        ...
        while (i44 < width) {
            ...
            int i67 = 0;
            while (i67 < i65) {
                iArr16[i62] = (iArr16[i62] & ViewCompat.MEASURED_STATE_MASK) | (iArr14[i56] << 16) | (iArr14[i66] << 8) | iArr14[i64];
                int i68 = i56 - i48;
                int i69 = i66 - i49;
                int i70 = i64 - i50;
