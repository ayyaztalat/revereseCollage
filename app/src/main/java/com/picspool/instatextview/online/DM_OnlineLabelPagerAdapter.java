...
import com.picspool.instatextview.labelview.DMLabelManager;

/* loaded from: classes3.dex */
public class DM_OnlineLabelPagerAdapter extends PagerAdapter {
    ...
    public DM_OnlineLabelPagerAdapter(DM_OnlineListLabelView dM_OnlineListLabelView) {
        Context context = dM_OnlineListLabelView.getContext();
        ...
        for (ImageView imageView : this.icViews) {
            if (imageView != null) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() { // from class: com.picspool.instatextview.online.DM_OnlineLabelPagerAdapter.1
                    @Override // android.view.View.OnClickListener
                    public void onClick(View view) {
                        try {
                            DM_OnlineLabelPagerAdapter.this.listLabelView.editText(DM_OnlineLabelPagerAdapter.this.labelManager.getTextDrawer(((Integer) view.getTag()).intValue()));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
