...
public class DMLabelSticker extends DMSticker {
    private Bitmap bitmap;
    private Context context;
    private DMTextDrawer textDrawer;
    private int textPadding;

    public DMLabelSticker(Context context, DMTextDrawer dMTextDrawer) {
        super(50);
        this.textPadding = 50;
    ...
    */
    public void updateBitmap() {
        /*
            r9 = this;
            com.picspool.lib.text.DMTextDrawer r0 = r9.textDrawer
        ...
        L1f:
            ...
            int r0 = r0.width()
            com.picspool.lib.text.DMTextDrawer r1 = r9.textDrawer
            android.graphics.Rect r1 = r1.getContentRect()
            int r1 = r1.height()
            com.picspool.lib.text.DMTextDrawer r2 = r9.textDrawer
            android.graphics.Rect r2 = r2.getTextContentRect()
            int r2 = r2.right
            com.picspool.lib.text.DMTextDrawer r3 = r9.textDrawer
        ...
        Lc8:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.picspool.instatextview.labelview.DMLabelSticker.updateBitmap():void");
    }
