...
public class DM_LabelPagerAdapter extends PagerAdapter {
    ...
    public DM_LabelPagerAdapter(DMListLabelView dMListLabelView) {
        ...
        for (ImageView imageView : this.icViews) {
            if (imageView != null) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() { // from class: com.picspool.instatextview.labelview.DM_LabelPagerAdapter.1
                    @Override // android.view.View.OnClickListener
                    public void onClick(View view) {
                        try {
                            DM_LabelPagerAdapter.this.listLabelView.editText(DM_LabelPagerAdapter.this.labelManager.getTextDrawer(((Integer) view.getTag()).intValue()));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
