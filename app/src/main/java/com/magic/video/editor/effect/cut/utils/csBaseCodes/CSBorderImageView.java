...
/* renamed from: com.magic.video.editor.effect.cut.utils.bg.CSBorderImageView */
/* loaded from: classes2.dex */
public class CSBorderImageView extends CSIgnoreRecycleImageView {
    int borderColor;
    float borderWidth;
    RectF boundRect;
    ...
    public CSBorderImageView(Context context) {
        super(context);
        this.borderColor = 0;
    ...
    public CSBorderImageView(Context context, AttributeSet attributeSet) {
    ...
    public CSBorderImageView(Context context, AttributeSet attributeSet, int i) {
    ...
    @Override // com.magic.video.editor.effect.cut.utils.p008bg.CSIgnoreRecycleImageView, android.widget.ImageView
    ...
    @Override // com.magic.video.editor.effect.cut.utils.p008bg.CSIgnoreRecycleImageView, android.widget.ImageView, android.view.View
    public void onDraw(Canvas canvas) {
        ...
        if (!this.isCircle) {
            if (!this.isFillet) {
                ...
                if (bitmap2 != null && !bitmap2.isRecycled()) {
                    ...
                    this.paint.reset();
                    if (filletBitmap != null && !filletBitmap.isRecycled()) {
                        canvas.drawBitmap(filletBitmap, rect3, rect2, this.paint);
                        if (filletBitmap != this.srcBitmap) {
        ...
        if (bitmap4 != null && !bitmap4.isRecycled()) {
            ...
            this.paint.reset();
            if (radiusRectBitmap == null || radiusRectBitmap.isRecycled()) {
                return;
            }
            canvas.drawBitmap(radiusRectBitmap, rect4, rect, this.paint);
            if (radiusRectBitmap != this.srcBitmap) {
