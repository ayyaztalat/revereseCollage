...
/* renamed from: itcm.sephiroth.android.library.cm.easing.Elastic */
...
public class Elastic implements Easing {
    ...
    public double easeIn(double d, double d2, double d3, double d4, double d5, double d6) {
        ...
        double d10 = d6 <= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? 0.3d * d4 : d6;
        if (d5 <= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE || d5 < Math.abs(d3)) {
            d7 = d10 / 4.0d;
            d8 = d3;
        } else {
    ...
    public double easeInOut(double d, double d2, double d3, double d4, double d5, double d6) {
        ...
        double d10 = d6 <= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? 0.44999999999999996d * d4 : d6;
        if (d5 <= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE || d5 < Math.abs(d3)) {
            d7 = d10 / 4.0d;
            d8 = d3;
        } else {
