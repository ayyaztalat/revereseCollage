...
public class CSStickerGroupViewAdapter extends RecyclerView.Adapter<CSStickerGroupViewAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new MyViewHolder(LayoutInflater.from(this.mContext).inflate(R.layout.view_stickerbar_group_item, viewGroup, false));
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() { // from class: com.baiwang.libuiinstalens.xlbsticker.stickerbar.CSStickerGroupViewAdapter.MyViewHolder.1
