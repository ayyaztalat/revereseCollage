...
public class BMKeyboardLayout extends RelativeLayout {
    ...
    public BMKeyboardLayout(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.mShowKeyboard = false;
        this.screenHeight = 0;
    }

    public BMKeyboardLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.mShowKeyboard = false;
        this.screenHeight = 0;
    }

    public BMKeyboardLayout(Context context) {
        super(context);
        this.mShowKeyboard = false;
        this.screenHeight = 0;
    }
