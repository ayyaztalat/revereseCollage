...
public class CSAdjustableFilterRes extends GPUFilterRes {
    ...
    @Override // com.picspool.instafilter.resource.GPUFilterRes
    ...
    @Override // com.picspool.instafilter.resource.GPUFilterRes, com.picspool.lib.resource.DMWBRes
        ...
        if (bitmap == null || bitmap.isRecycled()) {
            try {
                synchronized (this.src) {
                    asyncFilterForType(this.context, this.src, this.filterType, this.mix, new OnPostFilteredListener() { // from class: com.photo.editor.square.splash.view.filterbar.CSAdjustableFilterRes.1
