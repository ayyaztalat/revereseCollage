...
public final class AdaptScreenUtils {
    ...
    public static int pt2Px(float f) {
        return (int) (((f * C0879Utils.getApp().getResources().getDisplayMetrics().xdpi) / 72.0f) + 0.5d);
    }

    public static int px2Pt(float f) {
        return (int) (((f * 72.0f) / C0879Utils.getApp().getResources().getDisplayMetrics().xdpi) + 0.5d);
    }
    ...
    private static void applyDisplayMetrics(Resources resources, float f) {
        ...
        C0879Utils.getApp().getResources().getDisplayMetrics().xdpi = f;
