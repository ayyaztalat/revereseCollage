...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(C0879Utils.getApp().getPackageName());
    }

    public static List<String> getPermissions(String str) {
        try {
            String[] strArr = C0879Utils.getApp().getPackageManager().getPackageInfo(str, 4096).requestedPermissions;
            if (strArr == null) {
    ...
    public static boolean isGranted(String... strArr) {
        ...
        if (((List<?>) requestAndDeniedPermissions.second).isEmpty()) {
            for (Object str : requestAndDeniedPermissions.first) {
                if (!isGranted(String.valueOf(str))) {
                    return false;
                }
            }
            return true;
    ...
    private static boolean isGranted(String str) {
        return Build.VERSION.SDK_INT < 23 || ContextCompat.checkSelfPermission(C0879Utils.getApp(), str) == 0;
    }

    public static boolean isGrantedWriteSettings() {
        return Settings.System.canWrite(C0879Utils.getApp());
    }
    ...
    public static void startWriteSettingsActivity(Activity activity, int i) {
        ...
        intent.setData(Uri.parse("package:" + C0879Utils.getApp().getPackageName()));
    ...
    public static boolean isGrantedDrawOverlays() {
        return Settings.canDrawOverlays(C0879Utils.getApp());
    }
    ...
    public static void launchAppDetailsSettings() {
        Intent launchAppDetailsSettingsIntent = UtilsBridge.getLaunchAppDetailsSettingsIntent(C0879Utils.getApp().getPackageName(), true);
    ...
    public static final class PermissionActivityImpl extends UtilsTransActivity.TransActivityDelegate {
        ...
        public static void start(final int i) {
            UtilsTransActivity.start(new C0879Utils.Consumer<Intent>() { // from class: com.blankj.utilcode.util.PermissionUtils.PermissionActivityImpl.1
                @Override // com.blankj.utilcode.util.C0879Utils.Consumer
