...
public  final class ToastUtils {
    ...
    public final ToastUtils setLeftIcon(int i) {
        ToastUtils leftIcon = setLeftIcon(ContextCompat.getDrawable(C0879Utils.getApp(), i));
        if (leftIcon != null) {
            return leftIcon;
        }
    ...
    public final ToastUtils setTopIcon(int i) {
        ToastUtils topIcon = setTopIcon(ContextCompat.getDrawable(C0879Utils.getApp(), i));
        if (topIcon != null) {
            return topIcon;
        }
    ...
    public final ToastUtils setRightIcon(int i) {
        ToastUtils rightIcon = setRightIcon(ContextCompat.getDrawable(C0879Utils.getApp(), i));
        if (rightIcon != null) {
            return rightIcon;
        }
    ...
    public final ToastUtils setBottomIcon(int i) {
        ToastUtils bottomIcon = setBottomIcon(ContextCompat.getDrawable(C0879Utils.getApp(), i));
        if (bottomIcon != null) {
            return bottomIcon;
        }
    ...
    private void show(View view, int i, ToastUtils toastUtils) {
        if (view == null) {
...
//                newToast.show(i);
    ...
    public static IToast newToast(ToastUtils toastUtils) {
        if (!toastUtils.isNotUseSystemToast && NotificationManagerCompat.from(C0879Utils.getApp()).areNotificationsEnabled()) {
    ...
    public static final class WindowManagerToast extends AbsToast {
        ...
        WindowManagerToast(ToastUtils toastUtils, int i) {
            ...
            this.mWM = (WindowManager) C0879Utils.getApp().getSystemService(Context.WINDOW_SERVICE);
            this.mParams.type = i;
        }
        ...
        public void show(int i) {
            ...
            this.mParams.packageName = C0879Utils.getApp().getPackageName();
    ...
    public static final class ActivityToast extends AbsToast {
        ...
        private C0879Utils.ActivityLifecycleCallbacks mActivityLifecycleCallbacks;
        ...
        private void registerLifecycleCallback() {
            ...
            C0879Utils.ActivityLifecycleCallbacks activityLifecycleCallbacks = new C0879Utils.ActivityLifecycleCallbacks() { // from class: com.blankj.utilcode.util.ToastUtils.ActivityToast.2
                @Override // com.blankj.utilcode.util.C0879Utils.ActivityLifecycleCallbacks
    ...
    public static abstract class AbsToast implements IToast {
        protected Toast mToast = new Toast(C0879Utils.getApp());
        ...
        View getToastViewSnapshot(int i) {
            ...
            ImageView imageView = new ImageView(C0879Utils.getApp());
    ...
    public static final class UtilsMaxWidthRelativeLayout extends RelativeLayout {
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(MeasureSpec.makeMeasureSpec(UtilsBridge.getAppScreenWidth() - SPACING, MeasureSpec.AT_MOST), i2);
        }
    }
}
