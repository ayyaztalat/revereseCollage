...
public final class NetworkUtils {
    ...
    private static final Set<C0879Utils.Consumer<WifiScanResults>> SCAN_RESULT_CONSUMERS = new CopyOnWriteArraySet();
    ...
    public static void openWirelessSettings() {
        C0879Utils.getApp().startActivity(new Intent("android.settings.WIRELESS_SETTINGS").setFlags(
    ...
    public static C0879Utils.Task<Boolean> isAvailableAsync(C0879Utils.Consumer<Boolean> consumer) {
        if (consumer == null) {
        ...
        return UtilsBridge.doAsync(new C0879Utils.Task<>(consumer) { // from class: com.blankj.utilcode.util.NetworkUtils.1
    ...
    public static void isAvailableByPingAsync(C0879Utils.Consumer<Boolean> consumer) {
        isAvailableByPingAsync("", consumer);
    }

    public static C0879Utils.Task<Boolean> isAvailableByPingAsync(final String str, C0879Utils.Consumer<Boolean> consumer) {
        if (consumer == null) {
        ...
        return UtilsBridge.doAsync(new C0879Utils.Task<Boolean>(consumer) { // from class: com.blankj.utilcode.util.NetworkUtils.2
            @Override // com.blankj.utilcode.util.ThreadUtils.Task
            public Boolean doInBackground() {
    ...
    public static void isAvailableByDnsAsync(C0879Utils.Consumer<Boolean> consumer) {
        isAvailableByDnsAsync("", consumer);
    }

    public static C0879Utils.Task isAvailableByDnsAsync(final String str, C0879Utils.Consumer<Boolean> consumer) {
        if (consumer == null) {
            throw new NullPointerException("Argument 'consumer' of type Utils.Consumer<Boolean> (#1 out of 2, zero-based) is marked by @androidx.annotation.NonNull but got null for it");
        }
        return UtilsBridge.doAsync(new C0879Utils.Task<Boolean>(consumer) { // from class: com.blankj.utilcode.util.NetworkUtils.3
            @Override // com.blankj.utilcode.util.ThreadUtils.Task
            public Boolean doInBackground() {
    ...
    public static boolean getMobileDataEnabled() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        TelephonyManager telephonyManager = null;
        try {
            telephonyManager = (TelephonyManager) C0879Utils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static boolean getWifiEnabled() {
        WifiManager wifiManager = (WifiManager) C0879Utils.getApp().getSystemService(Context.WIFI_SERVICE);
        if (wifiManager == null) {
            return false;
        }
    ...
    public static boolean isWifiConnected() {
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) C0879Utils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static C0879Utils.Task<Boolean> isWifiAvailableAsync(C0879Utils.Consumer<Boolean> consumer) {
        if (consumer == null) {
            throw new NullPointerException("Argument 'consumer' of type Utils.Consumer<Boolean> (#0 out of 1, zero-based) is marked by @androidx.annotation.NonNull but got null for it");
        }
        return UtilsBridge.doAsync(new C0879Utils.Task<Boolean>(consumer) { // from class: com.blankj.utilcode.util.NetworkUtils.4
            @Override // com.blankj.utilcode.util.ThreadUtils.Task
            public Boolean doInBackground() {
    ...
    public static String getNetworkOperatorName() {
        TelephonyManager telephonyManager = (TelephonyManager) C0879Utils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static C0879Utils.Task<String> getIPAddressAsync(final boolean z, C0879Utils.Consumer<String> consumer) {
        if (consumer == null) {
        ...
        return UtilsBridge.doAsync(new C0879Utils.Task<String>(consumer) { // from class: com.blankj.utilcode.util.NetworkUtils.5
            @Override // com.blankj.utilcode.util.ThreadUtils.Task
    ...
    public static C0879Utils.Task<String> getDomainAddressAsync(final String str, C0879Utils.Consumer<String> consumer) {
        if (consumer == null) {
            throw new NullPointerException("Argument 'consumer' of type Utils.Consumer<String> (#1 out of 2, zero-based) is marked by @androidx.annotation.NonNull but got null for it");
        }
        return UtilsBridge.doAsync(new C0879Utils.Task<String>(consumer) { // from class: com.blankj.utilcode.util.NetworkUtils.6
            @Override // com.blankj.utilcode.util.ThreadUtils.Task
            public String doInBackground() {
    ...
    public static String getIpAddressByWifi() {
        WifiManager wifiManager = (WifiManager) C0879Utils.getApp().getSystemService(
    ...
    public static String getSSID() {
        ...
        WifiManager wifiManager = (WifiManager) C0879Utils.getApp().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
...
//        ActivityCompat.checkSelfPermission(, Manifest.permission.ACCESS_FINE_LOCATION);
        if (getWifiEnabled() && (scanResults = ((WifiManager) C0879Utils
                .getApp().getSystemService(Context.WIFI_SERVICE)).getScanResults()) != null) {
            wifiScanResults.setAllResults(scanResults);
        }
        return wifiScanResults;
    }

    public static void addOnWifiChangedConsumer(final C0879Utils.Consumer<WifiScanResults> consumer) {
        if (consumer == null) {
            return;
        }
        // from class: com.blankj.utilcode.util.NetworkUtils.7
// java.lang.Runnable
        ...
        timer.schedule(new TimerTask() { // from class: com.blankj.utilcode.util.NetworkUtils.8
            ...
            public void run() {
                ...
                UtilsBridge.runOnUiThread(new Runnable() { // from class: com.blankj.utilcode.util.NetworkUtils.8.1
                    ...
                    public void run() {
                        for (C0879Utils.Consumer consumer : NetworkUtils.SCAN_RESULT_CONSUMERS) {
                            consumer.accept(NetworkUtils.sPreWifiScanResults);
                        }
                    }
                });
    ...
    public static void startScanWifiIfEnabled() {
        if (getWifiEnabled()) {
            ((WifiManager) C0879Utils.getApp().getSystemService(Context.WIFI_SERVICE)).startScan();
        }
    }

    public static void removeOnWifiChangedConsumer(final C0879Utils.Consumer<WifiScanResults> consumer) {
        if (consumer == null) {
            return;
        }
            ...
            UtilsBridge.runOnUiThread(new Runnable() { // from class: com.blankj.utilcode.util.NetworkUtils.NetworkChangedReceiver.1
                ...
                public void run() {
                    ...
                    if (size == 0 && NetworkChangedReceiver.this.mListeners.size() == 1) {
                        ...
                        C0879Utils.getApp().registerReceiver(NetworkChangedReceiver.access$000(), new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
                    }
                }
            });
        }
            ...
            UtilsBridge.runOnUiThread(new Runnable() { // from class: com.blankj.utilcode.util.NetworkUtils.NetworkChangedReceiver.2
                ...
                public void run() {
                    ...
                    if (size == 1 && NetworkChangedReceiver.this.mListeners.size() == 0) {
                        C0879Utils.getApp().unregisterReceiver(NetworkChangedReceiver.access$000());
                    }
                }
            });
        }
