...
public final class ActivityUtils {
    ...
    public static void addActivityLifecycleCallbacks(C0879Utils.ActivityLifecycleCallbacks activityLifecycleCallbacks) {
        UtilsBridge.addActivityLifecycleCallbacks(activityLifecycleCallbacks);
    }

    public static void addActivityLifecycleCallbacks(Activity activity, C0879Utils.ActivityLifecycleCallbacks activityLifecycleCallbacks) {
        UtilsBridge.addActivityLifecycleCallbacks(activity, activityLifecycleCallbacks);
    }

    public static void removeActivityLifecycleCallbacks(C0879Utils.ActivityLifecycleCallbacks activityLifecycleCallbacks) {
    ...
    public static void removeActivityLifecycleCallbacks(Activity activity, C0879Utils.ActivityLifecycleCallbacks activityLifecycleCallbacks) {
    ...
    public static void startActivityForResult(Fragment fragment, Class<? extends Activity> cls, int i) {
        ...
        startActivityForResult(fragment, (Bundle) null, C0879Utils.getApp().getPackageName(), cls.getName(), i, (Bundle) null);
    }
    ...
    public static void startActivityForResult(Fragment fragment, Class<? extends Activity> cls, int i, Bundle bundle) {
        ...
        startActivityForResult(fragment, (Bundle) null, C0879Utils.getApp().getPackageName(), cls.getName(), i, bundle);
    }
    ...
    public static void startActivityForResult(Fragment fragment, Class<? extends Activity> cls, int i, View... viewArr) {
        ...
        startActivityForResult(fragment, (Bundle) null, C0879Utils.getApp().getPackageName(), cls.getName(), i, getOptionsBundle(fragment, viewArr));
    }
    ...
    public static void startActivityForResult(Fragment fragment, Class<? extends Activity> cls, int i, int i2, int i3) {
        ...
        startActivityForResult(fragment, (Bundle) null, C0879Utils.getApp().getPackageName(), cls.getName(), i, getOptionsBundle(fragment, i2, i3));
    }
    ...
    public static void startActivityForResult(Bundle bundle, Fragment fragment, Class<? extends Activity> cls, int i) {
        ...
        startActivityForResult(fragment, bundle, C0879Utils.getApp().getPackageName(), cls.getName(), i, (Bundle) null);
    }
    ...
    public static void startActivityForResult(Bundle bundle, Fragment fragment, Class<? extends Activity> cls, int i, Bundle bundle2) {
        ...
        startActivityForResult(fragment, bundle, C0879Utils.getApp().getPackageName(), cls.getName(), i, bundle2);
    }
    ...
    public static void startActivityForResult(Bundle bundle, Fragment fragment, Class<? extends Activity> cls, int i, View... viewArr) {
        ...
        startActivityForResult(fragment, bundle, C0879Utils.getApp().getPackageName(), cls.getName(), i, getOptionsBundle(fragment, viewArr));
    }
    ...
    public static void startActivityForResult(Bundle bundle, Fragment fragment, Class<? extends Activity> cls, int i, int i2, int i3) {
        ...
        startActivityForResult(fragment, bundle, C0879Utils.getApp().getPackageName(), cls.getName(), i, getOptionsBundle(fragment, i2, i3));
    }
    ...
    public static void startLauncherActivity() {
        startLauncherActivity(C0879Utils.getApp().getPackageName());
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(C0879Utils.getApp().getPackageName());
    }
    ...
    public static String getLauncherActivity(String str) {
        ...
        List<ResolveInfo> queryIntentActivities = C0879Utils.getApp().getPackageManager().queryIntentActivities(intent, 0);
        return (queryIntentActivities == null || queryIntentActivities.size() == 0) ? "" : queryIntentActivities.get(0).activityInfo.name;
    }

    public static List<String> getMainActivities() {
        return getMainActivities(C0879Utils.getApp().getPackageName());
    }
    ...
    public static Drawable getActivityIcon(Class<? extends Activity> cls) {
        ...
        return getActivityIcon(new ComponentName(C0879Utils.getApp(), cls));
    }
    ...
    public static Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            return C0879Utils.getApp().getPackageManager().getActivityIcon(componentName);
    ...
    public static Drawable getActivityLogo(Class<? extends Activity> cls) {
        ...
        return getActivityLogo(new ComponentName(C0879Utils.getApp(), cls));
    }
    ...
    public static Drawable getActivityLogo(ComponentName componentName) {
        ...
        try {
            return C0879Utils.getApp().getPackageManager().getActivityLogo(componentName);
        } catch (PackageManager.NameNotFoundException e) {
            e.printStackTrace();
            return null;
        }
    ...
    private static boolean isIntentAvailable(Intent intent) {
        return C0879Utils.getApp().getPackageManager().queryIntentActivities(intent, 65536).size() > 0;
    }
    ...
    private static Context getTopActivityOrApp() {
        if (UtilsBridge.isAppForeground()) {
            ...
            return topActivity == null ? C0879Utils.getApp() : topActivity;
        }
        return C0879Utils.getApp();
    }
}
