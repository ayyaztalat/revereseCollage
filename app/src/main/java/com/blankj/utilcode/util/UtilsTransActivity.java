...
public class UtilsTransActivity extends AppCompatActivity {
    ...
    public static void start(Activity activity, C0879Utils.Consumer<Intent> consumer, TransActivityDelegate transActivityDelegate, Class<?> cls) {
        if (transActivityDelegate == null) {
            return;
        }
        Intent intent = new Intent(C0879Utils.getApp(), cls);
