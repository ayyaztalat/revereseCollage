...
public class ViewUtils {
    ...
    public static boolean isLayoutRtl() {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            if (Build.VERSION.SDK_INT >= 24) {
                locale = C0879Utils.getApp().getResources().getConfiguration().getLocales().get(0);
            } else {
                locale = C0879Utils.getApp().getResources().getConfiguration().locale;
            }
    ...
    public static View layoutId2View(int i) {
        return ((LayoutInflater) C0879Utils.getApp().getSystemService("layout_inflater")).inflate(i, (ViewGroup) null);
    }
}
