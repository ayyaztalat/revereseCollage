...
public final class MetaDataUtils {
    ...
    public static String getMetaDataInApp(String str) {
        ...
        try {
            return String.valueOf(C0879Utils.getApp().getPackageManager().getApplicationInfo(C0879Utils.getApp().getPackageName(), 128).metaData.get(str));
    ...
    public static String getMetaDataInActivity(Class<? extends Activity> cls, String str) {
        if (cls != null) {
            ...
            try {
                return String.valueOf(C0879Utils.getApp().getPackageManager().getActivityInfo(new ComponentName(C0879Utils.getApp(), cls), 128).metaData.get(str));
            } catch (PackageManager.NameNotFoundException e) {
                e.printStackTrace();
                return "";
            }
    ...
    public static String getMetaDataInService(Class<? extends Service> cls, String str) {
        if (cls != null) {
            ...
            try {
                return String.valueOf(C0879Utils.getApp().getPackageManager().getServiceInfo(new ComponentName(C0879Utils.getApp(), cls), 128).metaData.get(str));
            } catch (PackageManager.NameNotFoundException e) {
                e.printStackTrace();
                return "";
            }
    ...
    public static String getMetaDataInReceiver(Class<? extends BroadcastReceiver> cls, String str) {
        if (cls != null) {
            ...
            try {
                return String.valueOf(C0879Utils.getApp().getPackageManager().getReceiverInfo(new ComponentName(C0879Utils.getApp(), cls), 128).metaData.get(str));
            } catch (PackageManager.NameNotFoundException e) {
                e.printStackTrace();
                return "";
            }
