...
public final class SDCardUtils {
    ...
    public static List<SDCardInfo> getSDCardInfo() {
        ...
        StorageManager storageManager = (StorageManager) C0879Utils.getApp().getSystemService("storage");
    ...
    public static class SDCardInfo {
        ...
        public String toString() {
            return "SDCardInfo {path = " + this.path + ", state = " + this.state + ", isRemovable = " + this.isRemovable + ", totalSize = " + Formatter.formatFileSize(C0879Utils.getApp(), this.totalSize) + ", availableSize = " + Formatter.formatFileSize(C0879Utils.getApp(), this.availableSize) + '}';
        }
    }
}
