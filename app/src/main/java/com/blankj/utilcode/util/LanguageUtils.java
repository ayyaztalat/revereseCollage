...
public class LanguageUtils {
    ...
    private static void applyLanguageReal(Locale locale, final boolean z) {
        ...
        updateAppContextLanguage(locale, new C0879Utils.Consumer<Boolean>() { // from class: com.blankj.utilcode.util.LanguageUtils.1
    ...
    public static Locale getAppContextLanguage() {
        return getContextLanguage(C0879Utils.getApp());
    }
    ...
    public static void updateAppContextLanguage(Locale locale, C0879Utils.Consumer<Boolean> consumer) {
        if (locale == null) {
    ...
    static void pollCheckAppContextLocal(final Locale locale, final int i, final C0879Utils.Consumer<Boolean> consumer) {
        ...
        C0879Utils.getApp().getResources().updateConfiguration(configuration, resources.getDisplayMetrics());
        if (consumer == null) {
            return;
        }
    ...
    public static void applyLanguage(Activity activity) {
        ...
        updateConfiguration(C0879Utils.getApp(), string2Locale);
    }
