...
public final class ServiceUtils {
    ...
    public static Set<String> getAllRunningServices() {
        List<ActivityManager.RunningServiceInfo> runningServices = ((ActivityManager) C0879Utils.getApp().getSystemService("activity")).getRunningServices(Integer.MAX_VALUE);
    ...
    public static void startService(Class<?> cls) {
        ...
        startService(new Intent(C0879Utils.getApp(), cls));
    }
    ...
    public static void startService(Intent intent) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= 26) {
                C0879Utils.getApp().startForegroundService(intent);
            } else {
                C0879Utils.getApp().startService(intent);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static boolean stopService(Class<?> cls) {
        ...
        return stopService(new Intent(C0879Utils.getApp(), cls));
    }
    ...
    public static boolean stopService(Intent intent) {
        ...
        try {
            return C0879Utils.getApp().stopService(intent);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public static void bindService(Class<?> cls, ServiceConnection serviceConnection, int i) {
        ...
        bindService(new Intent(C0879Utils.getApp(), cls), serviceConnection, i);
    }
    ...
    public static void bindService(Intent intent, ServiceConnection serviceConnection, int i) {
        ...
        try {
            C0879Utils.getApp().bindService(intent, serviceConnection, i);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void unbindService(ServiceConnection serviceConnection) {
        ...
        C0879Utils.getApp().unbindService(serviceConnection);
    }
