...
public class MessengerUtils {
    ...
    public static void register() {
        if (UtilsBridge.isMainProcess()) {
            if (UtilsBridge.isServiceRunning(ServerService.class.getName())) {
                ...
                startServiceCompat(new Intent(C0879Utils.getApp(), ServerService.class));
            }
    ...
    public static void unregister() {
        if (UtilsBridge.isMainProcess()) {
            if (!UtilsBridge.isServiceRunning(ServerService.class.getName())) {
                ...
                C0879Utils.getApp().stopService(new Intent(C0879Utils.getApp(), ServerService.class));
            }
        }
    ...
    public static void post(String str, Bundle bundle) {
        ...
        if (client != null) {
            ...
            Intent intent = new Intent(C0879Utils.getApp(), ServerService.class);
    ...
    static class Client {
        ...
        boolean bind() {
            if (TextUtils.isEmpty(this.mPkgName)) {
                return C0879Utils.getApp().bindService(new Intent(C0879Utils.getApp(), ServerService.class), this.mConn, 1);
                ...
                if (UtilsBridge.isAppRunning(this.mPkgName)) {
                    ...
                    return C0879Utils.getApp().bindService(intent, this.mConn, 1);
                }
        ...
        void unbind() {
            ...
            try {
                C0879Utils.getApp().unbindService(this.mConn);
