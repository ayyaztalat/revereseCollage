...
public final class PhoneUtils {
    ...
    */
    public static String getImeiOrMeid(boolean r12) {
        /*
    ...
    public static void dial(String str) {
        ...
        C0879Utils.getApp().startActivity(UtilsBridge.getDialIntent(str));
    }
    ...
    public static void call(String str) {
        ...
        C0879Utils.getApp().startActivity(UtilsBridge.getCallIntent(str));
    }
    ...
    public static void sendSms(String str, String str2) {
        ...
        C0879Utils.getApp().startActivity(UtilsBridge.getSendSmsIntent(str, str2));
    }

    private static TelephonyManager getTelephonyManager() {
        return (TelephonyManager) C0879Utils.getApp().getSystemService("phone");
    }
}
