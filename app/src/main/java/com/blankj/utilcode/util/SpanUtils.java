...
public final class SpanUtils {
    ...
    public static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(Bitmap bitmap, int i) {
            super(i);
            BitmapDrawable bitmapDrawable = new BitmapDrawable(C0879Utils.getApp().getResources(), bitmap);
        ...
        public Drawable getDrawable() {
            ...
            if (this.mContentUri != null) {
                try {
                    openInputStream = C0879Utils.getApp().getContentResolver().openInputStream(this.mContentUri);
                    bitmapDrawable = new BitmapDrawable(C0879Utils.getApp().getResources(), BitmapFactory.decodeStream(openInputStream));
                } catch (Exception e) {
                    e = e;
                }
                try {
                    ...
                    Log.e("sms", "Failed to loaded content " + this.mContentUri, e2);
                    return bitmapDrawable2;
                }
            }
            try {
                drawable = ContextCompat.getDrawable(C0879Utils.getApp(), this.mResourceId);
    ...
    public static class ShadowSpan extends CharacterStyle implements UpdateAppearance {
        ...
        /* renamed from: dx */
        private float f124dx;

        /* renamed from: dy */
        private float f125dy;
        ...
        @Override // android.text.style.CharacterStyle
        public void updateDrawState(TextPaint textPaint) {
            textPaint.setShadowLayer(this.radius, this.f124dx, this.f125dy, this.shadowColor);
        }
    }
