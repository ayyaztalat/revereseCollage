...
public final class DeviceUtils {
    ...
    public static boolean isAdbEnabled() {
        return Settings.Secure.getInt(C0879Utils.getApp().getContentResolver(), "adb_enabled", 0) > 0;
    }
    ...
    public static String getAndroidID() {
        String string = Settings.Secure.getString(C0879Utils.getApp().getContentResolver(), "android_id");
    ...
    private static boolean getWifiEnabled() {
        WifiManager wifiManager = (WifiManager) C0879Utils.getApp().getSystemService("wifi");
        if (wifiManager == null) {
            return false;
        }
    ...
    private static String getMacAddressByWifiInfo() {
        ...
        try {
            WifiManager wifiManager = (WifiManager) C0879Utils.getApp().getApplicationContext().getSystemService("wifi");
    ...
    public static boolean isEmulator() {
        ...
        return intent.resolveActivity(C0879Utils.getApp().getPackageManager()) == null;
    }

    public static boolean isDevelopmentSettingsEnabled() {
        return Settings.Global.getInt(C0879Utils.getApp().getContentResolver(), "development_settings_enabled", 0) > 0;
    }
