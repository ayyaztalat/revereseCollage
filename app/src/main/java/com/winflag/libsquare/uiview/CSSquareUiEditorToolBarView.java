...
public class CSSquareUiEditorToolBarView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        findViewById(R.id.item_fill).setOnClickListener(new OnClickListener() { // from class: com.winflag.libsquare.uiview.CSSquareUiEditorToolBarView.1
        ...
        findViewById(R.id.item_square).setOnClickListener(new OnClickListener() { // from class: com.winflag.libsquare.uiview.CSSquareUiEditorToolBarView.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (CSSquareUiEditorToolBarView.this.mListener != null) {
        ...
        findViewById(R.id.item_horizontal).setOnClickListener(new OnClickListener() { // from class: com.winflag.libsquare.uiview.CSSquareUiEditorToolBarView.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (CSSquareUiEditorToolBarView.this.mListener != null) {
        ...
        findViewById(R.id.item_vertial).setOnClickListener(new OnClickListener() { // from class: com.winflag.libsquare.uiview.CSSquareUiEditorToolBarView.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (CSSquareUiEditorToolBarView.this.mListener != null) {
        ...
        findViewById(R.id.item_left).setOnClickListener(new OnClickListener() { // from class: com.winflag.libsquare.uiview.CSSquareUiEditorToolBarView.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (CSSquareUiEditorToolBarView.this.mListener != null) {
        ...
        findViewById(R.id.item_right).setOnClickListener(new OnClickListener() { // from class: com.winflag.libsquare.uiview.CSSquareUiEditorToolBarView.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (CSSquareUiEditorToolBarView.this.mListener != null) {
