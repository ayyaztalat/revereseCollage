...
import com.touch.android.library.imagezoom.LightImageView;
import com.winflag.libsquare.manager.CSSquareUiFrameManager;
import com.winflag.libsquare.res.CSGradientRes;
...
public class CSSquareView extends RelativeLayout implements DMColorStraw.OnStrawingListener, OnDMViewColorChangedListener, DMStickerStateCallback {
    ...
    private Bitmap choosedBgBitmap;
    ...
    public void setGlitchFilter(Bitmap bitmap) {
        ...
        this.src = bitmap;
        boolean z = this.mIsBlurBackground;
        if (z) {
            float f = this.ratio;
            setBlurBackground(f, f, z);
        }
        updateImagePic(null);
    }
    ...
    public void setShape(DMWBRes dMWBRes) {
        if (dMWBRes != null) {
            ...
            createShapeFinal(this.shapeSize, new OnShapeFinishedListener() { // from class: com.winflag.libsquare.view.CSSquareView.1
                @Override // com.winflag.libsquare.view.CSSquareView.OnShapeFinishedListener
    ...
    public void setForeground(DMWBRes dMWBRes, int i) {
        if (dMWBRes != null) {
            ...
            if (this.currentShapeRes != null) {
                this.img_fg.setImageBitmap(null);
                createShapeFinal(this.shapeSize, new OnShapeFinishedListener() { // from class: com.winflag.libsquare.view.CSSquareView.2
                    @Override // com.winflag.libsquare.view.CSSquareView.OnShapeFinishedListener
    ...
    public void setBlurBitmap(Bitmap bitmap) {
        ...
        if (this.currentShapeRes != null) {
            this.img_fg.setImageBitmap(null);
            createShapeFinal(this.shapeSize, new OnShapeFinishedListener() { // from class: com.winflag.libsquare.view.CSSquareView.3
                @Override // com.winflag.libsquare.view.CSSquareView.OnShapeFinishedListener
                public void onXorImage(Bitmap bitmap2) {
                    CSSquareView.this.mShapeFinal = bitmap2;
                    CSSquareView.this.img_fg.setImageBitmap(CSSquareView.this.mShapeFinal);
    ...
    public void setForegroundGradient(GradientDrawable gradientDrawable) {
        if (gradientDrawable != null) {
            ...
            if (this.currentShapeRes != null) {
                this.img_fg.setImageBitmap(null);
                createShapeFinal(this.shapeSize, new OnShapeFinishedListener() { // from class: com.winflag.libsquare.view.CSSquareView.4
                    @Override // com.winflag.libsquare.view.CSSquareView.OnShapeFinishedListener
                    public void onXorImage(Bitmap bitmap2) {
                        CSSquareView.this.mShapeFinal = bitmap2;
                        CSSquareView.this.img_fg.setImageBitmap(CSSquareView.this.mShapeFinal);
    ...
    public void createShapeFinal(final int i, final OnShapeFinishedListener onShapeFinishedListener) {
        this.currentShapeRes.getImageBitmap(getContext(), new DMWBImageRes.OnResImageLoadListener() { // from class: com.winflag.libsquare.view.CSSquareView.5
                ...
                if (CSSquareView.this.groundMode != 1) {
                    if (CSSquareView.this.groundMode == 2) {
                        ...
                        if (CSSquareView.this.groundMode == 4) {
                            if (CSSquareView.this.mBlurBitmap != null && !CSSquareView.this.mBlurBitmap.isRecycled()) {
                                Bitmap bitmap2 = CSSquareView.this.mBlurBitmap;
                                int i7 = i;
    ...
    public void setBlurBackground(Bitmap bitmap, boolean z) {
        if (z) {
            this.choosedBgBitmap = bitmap;
            Bitmap cropCenterScaleBitmap = DMBitmapCrop.cropCenterScaleBitmap(bitmap, 300, 300);
            if (cropCenterScaleBitmap == null || cropCenterScaleBitmap.isRecycled()) {
                return;
            }
            float f = this.ratio;
            if (f != 0.0f) {
                cropCenterScaleBitmap = blur(cropCenterScaleBitmap, (int) (f * 55.0f), true);
            }
            if (cropCenterScaleBitmap == null || cropCenterScaleBitmap.isRecycled()) {
                return;
            }
            BitmapDrawable bitmapDrawable = new BitmapDrawable(getResources(), cropCenterScaleBitmap.copy(cropCenterScaleBitmap.getConfig(), true));
            bitmapDrawable.setBounds(0, 0, getWidth(), getHeight());
            setSquareBackground(bitmapDrawable, true);
            setBlurBitmap(cropCenterScaleBitmap);
        }
    }
    ...
    public void setBlurBackground(float f, float f2, boolean z) {
        if (Math.abs(f - f2) > 0.001d || z) {
            this.ratio = f2;
            Bitmap bitmap = null;
            Bitmap bitmap2 = this.choosedBgBitmap;
            if (bitmap2 == null || bitmap2.isRecycled()) {
                DMWBRes dMWBRes = this.curFilterRes;
                if (dMWBRes != null) {
                    Bitmap filterForType = GPUFilter.filterForType(this.mContext, this.src, ((GPUFilterRes) dMWBRes).getFilterType());
                    Bitmap cropCenterScaleBitmap = DMBitmapCrop.cropCenterScaleBitmap(filterForType, 300, 300);
                    ...
                    bitmap = DMBitmapCrop.cropCenterScaleBitmap(this.src, 300, 300);
                }
            } else {
                try {
                    bitmap = DMBitmapCrop.cropCenterScaleBitmap(this.choosedBgBitmap, 300, 300);
            ...
            if (f2 != 0.0f) {
                bitmap = blur(bitmap, (int) (f2 * 55.0f), true);
            }
            if (bitmap == null || bitmap.isRecycled()) {
                return;
            }
            BitmapDrawable bitmapDrawable = new BitmapDrawable(getResources(), bitmap.copy(bitmap.getConfig(), true));
            bitmapDrawable.setBounds(0, 0, getWidth(), getHeight());
            setSquareBackground(bitmapDrawable, true);
    ...
    public void setSquareBackgroundRes(DMWBRes dMWBRes) {
        if (dMWBRes instanceof DMWBColorRes) {
            ...
            dMWBImageRes2.setContext(this.mContext);
            dMWBImageRes2.setImageFileName(dMWBImageRes.getImageFileName());
            if (dMWBImageRes.getImageType() == DMWBRes.LocationType.ASSERT) {
                dMWBImageRes2.setImageType(DMWBRes.LocationType.ASSERT);
            }
            if (dMWBImageRes.getScaleType() == DMWBImageRes.FitType.TITLE) {
                dMWBImageRes2.setScaleType(DMWBImageRes.FitType.TITLE);
            } else if (dMWBImageRes.getScaleType() == DMWBImageRes.FitType.SCALE) {
                dMWBImageRes2.setScaleType(DMWBImageRes.FitType.SCALE);
            }
            if (dMWBImageRes.getScaleType() == DMWBImageRes.FitType.TITLE) {
                BitmapDrawable bitmapDrawable = new BitmapDrawable(getResources(), dMWBImageRes2.getLocalImageBitmap());
                bitmapDrawable.setTileModeXY(Shader.TileMode.REPEAT, Shader.TileMode.REPEAT);
                bitmapDrawable.setDither(true);
                setSquareBackground(bitmapDrawable, false);
            } else if (dMWBImageRes.getScaleType() == DMWBImageRes.FitType.SCALE) {
                dMWBImageRes2.setScaleType(DMWBImageRes.FitType.SCALE);
                BitmapDrawable bitmapDrawable2 = new BitmapDrawable(getResources(), dMWBImageRes2.getLocalImageBitmap());
    ...
    public void getSizeBitmap(int i) {
        ...
        if (this.currentShapeRes != null) {
            ...
            if (bitmap != null && !bitmap.isRecycled()) {
                ...
                createShapeFinal(i, new OnShapeFinishedListener() { // from class: com.winflag.libsquare.view.CSSquareView.6
                    @Override // com.winflag.libsquare.view.CSSquareView.OnShapeFinishedListener
                    public void onXorImage(Bitmap bitmap2) {
                        if (bitmap2 == null) {
                            return;
    ...
    @Override // org.picspool.lib.widget.listener.OnDMViewColorChangedListener
    public void onColorChanged(int i, boolean z) {
        setSquareBackground(new ColorDrawable(i), false);
    }

    @Override // org.picspool.lib.widget.colorstraw.DMColorStraw.OnStrawingListener
    ...
    public void setOverlapping(boolean z) {
        if (z) {
            DMWBRes res = new CSSquareUiFrameManager(getContext()).getRes("border_white");
    ...
    public void setBitmapWithStatKeep(Bitmap bitmap) {
        ...
        CSAsyncSizeProcess.executeAsyncFilter(this.mContext, this.src, this.curFilterRes, this.curVigRes, null, new OnPostFilteredListener() { // from class: com.winflag.libsquare.view.CSSquareView.7
    ...
    private void updateImagePic(final OnFilterFinishedListener onFilterFinishedListener) {
        Bitmap bitmap = this.src;
        if (bitmap != null && !bitmap.isRecycled()) {
            CSAsyncSizeProcess.executeAsyncFilter(this.mContext, this.src, this.curFilterRes, this.curVigRes, null, new OnPostFilteredListener() { // from class: com.winflag.libsquare.view.CSSquareView.8
                @Override // org.picspool.lib.filter.listener.OnPostFilteredListener
                public void postFiltered(Bitmap bitmap2) {
                    CSSquareView.this.img_pic.setImageBitmapWithStatKeep(null);
                    if (CSSquareView.this.dst != null && !CSSquareView.this.dst.isRecycled() && CSSquareView.this.dst != CSSquareView.this.src) {
                    ...
                    CSSquareView.this.dst = bitmap2;
                    if (CSSquareView.this.colorMatrixColorFilter != null) {
                        Paint paint = new Paint(1);
                        paint.setColorFilter(CSSquareView.this.colorMatrixColorFilter);
                        Bitmap createBitmap = Bitmap.createBitmap(CSSquareView.this.dst.getWidth(), CSSquareView.this.dst.getHeight(), Bitmap.Config.ARGB_8888);
                        new Canvas(createBitmap).drawBitmap(CSSquareView.this.dst, 0.0f, 0.0f, paint);
                        CSSquareView.this.dst = createBitmap;
                    }
                    if (CSSquareView.this.adjustImageFilter != null) {
                        CSSquareView cSSquareView = CSSquareView.this;
                        cSSquareView.dst = GPUFilter.filterForFilter(cSSquareView.dst, CSSquareView.this.adjustImageFilter);
                    }
                    CSSquareView.this.img_pic.setImageBitmapWithStatKeep(CSSquareView.this.dst);
                    CSSquareView.this.img_pic.resetBitmap();
                    CSSquareView.this.img_pic.invalidate();
