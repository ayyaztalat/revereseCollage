...
public abstract class ImageViewTouchBase extends DMIgnoreRecycleImageView implements IDisposable {
    ...
    protected float getDefaultScale(DisplayType displayType) {
        ...
        } else if (displayType == DisplayType.SMALLER_IF_FIT) {
            return Math.min(1.0f, 1.0f / getScale(this.mBaseMatrix)) * 0.95f;
        } else {
    ...
    public void setImageDrawable(final Drawable drawable, final Matrix matrix, final float f, final float f2) {
        if (getWidth() <= 0) {
            this.mLayoutRunnable = new Runnable() { // from class: touch.android.library.imagezoom.ImageViewTouchBase.1
    ...
    public float getScale() {
        ...
        Log.v("ImageViewTouchBase", String.valueOf(this.mEldScale));
    ...
    */
    protected RectF getCenter(Matrix r6, boolean r7, boolean r8) {
        ...
        L69:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: touch.android.library.imagezoom.ImageViewTouchBase.getCenter(android.graphics.Matrix, boolean, boolean):android.graphics.RectF");
    }
    ...
    protected void scrollBy(float f, float f2, final double d) {
        ...
        this.mHandler.post(new Runnable() { // from class: touch.android.library.imagezoom.ImageViewTouchBase.2
    ...
    protected void zoomTo(float f, float f2, float f3, final float f4) {
        ...
        this.mHandler.post(new Runnable() { // from class: touch.android.library.imagezoom.ImageViewTouchBase.3
            @Override // java.lang.Runnable
            public void run() {
                float min = Math.min(f4, (float) (System.currentTimeMillis() - currentTimeMillis));
                ImageViewTouchBase.this.zoomTo(scale + ((float) ImageViewTouchBase.this.mEasing.easeInOut(min, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, f5, f4)), f6, f7);
                if (min < f4) {
                    ImageViewTouchBase.this.mHandler.post(this);
                    return;
                }
